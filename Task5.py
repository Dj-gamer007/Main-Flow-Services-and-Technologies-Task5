...
root.iconbitmap("C:\\Users\\jayaraman\\Downloads\\icon.ico")
root.minsize(600, 270)
root.maxsize(600, 270)

image = Image.open("C:\\Users\\jayaraman\\Downloads\\currency.png")
zoom = 0.5
...
def show_data():
    ...
    to_currency = c2.get()
    url = "http://api.currencylayer.com/live?access_key=6a352c92f40623cae38014ccc1fe3e2c&format=1"
